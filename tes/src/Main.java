...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Menu loaded from menu.txt (if exists).");
        } catch (Exception e) {
            System.out.println("No saved menu found or failed to load: " + e.getMessage());
        }
            ...
            try {
                switch (pilihan) {
                    ...
                    case "2":
                        ...
                        System.out.print("Harga: ");
                        double hargaMin = Double.parseDouble(sc.nextLine());
                        System.out.print("Kategori: ");
                        String kategoriMin = sc.nextLine();
                        System.out.print("Jenis minuman: ");
                        String jenisMin = sc.nextLine();
                        menu.addItem(new Minuman(namaMin, hargaMin, kategoriMin, jenisMin));
